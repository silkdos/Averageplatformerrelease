...
public class CameraFlightFollow : MonoBehaviour {
	...
	public float follow_distance = 7.0f; //How far behind the camera will follow the targeter.
	public float camera_elevation = 4.0f; //How high the camera will rise above the targeter's Z axis.
	...
	public float afterburner_Shake_Amount = 0.2f; //How much the camera will shake when afterburners are active.
